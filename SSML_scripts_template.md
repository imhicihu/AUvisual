...
<p><s><break time="195ms"/><emphasis>¡Hola!,</emphasis><break time="595ms"/>soy la Dra. &&&&&&&&, pertenezco a la sección Geografía, del Instituto Multidisciplinario de Historia y Ciencias Humanas y <emphasis>mi especialización</emphasis> <break time="95ms"/> son los sistemas de información geográfica (GIS).</s></p>
